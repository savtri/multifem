function DrawMicrostructures3D( VisibleIndex,SaveIndex,Coarse,InputIndex,fid,figureID )
%% Visible Index
...
for i=1:InputIndex.NumberOfElements %Loop over elements
    ...
    %% Draw Solid
    DrawSolid(i,XYZ,NodeIndex,InputIndex.xCentroid(i,1),InputIndex.yCentroid(i,1),InputIndex.zCentroid(i,1),1,cmap,Coarse(i).MicrostructureType)            
end
axis equal
grid on
box on
